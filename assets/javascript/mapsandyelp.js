        ...
        google.maps.event.addListener(marker, 'click', (function (marker, i) {
          return function () {
            ...
            $.ajax({
              ...
              console.log('res', res)
              $(".review-insert").empty().append("Rating: " + res.rating, "<br>" + "Price: " + res.price + "<br>");
              for (var i = 0; i < res.photos.length; i++) {
                var reviewImage = $("<img>");
                reviewImage.attr("src", res.photos[i]);
                reviewImage.addClass("review-image");
                $(".review-insert").append(reviewImage);
              }
